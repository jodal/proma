...
// Performs the login and the initial creation of the cookie
  ...
  $cookie_array[userid] = $row[0];
  $cookie_array[password] = $row[1];
...
/*
  $sharppos = strpos($cookie_value, "###");
  $userid = substr($cookie_value, 0, $sharppos);
  $passwd = substr($cookie_value, $sharppos+3);
*/
